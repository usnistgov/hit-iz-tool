# Docker NIST Immunization Test Suite Deployment Guide
...
2. Locate the `onc-tomcat:image` property
3. Change the image link from `nist775hit/hit-iz-onc-tool:latest` to `nist775hit/hit-iz-onc-tool:TOOLVERSION`
4. Save the file
